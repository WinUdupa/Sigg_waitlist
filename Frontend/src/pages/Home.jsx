...
<nav className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-full px-8 py-4">
  ...
  <h1 className="text-5xl md:text-7xl font-bold mb-8 max-w-4xl leading-tight">
    <TextType texts={["Siggraph BNMIT", "Welcome to the Event", "Join the Global Community"]} />
  </h1>

  <div className="flex space-x-4">
    <Link to="/getstarted">
      <button className="bg-white text-black px-8 py-3 rounded-full font-medium hover:bg-gray-100 pointer-events-auto">
        Join the Waitlist
      </button>
    </Link>

    {/* <Link to="/learnmore">
      <button className="border border-gray-500 text-white px-8 py-3 rounded-full font-medium hover:bg-white/10 pointer-events-auto">
        Learn More
      </button>
    </Link> */}
  </div>
